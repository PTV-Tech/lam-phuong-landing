...
import {JobPostingListItem} from "@/type";
...
export default function ClientView({
    ...
    const [records, setRecords] = useState<JobPostingListItem[]>(data);
                        ...
                        <div className="col-span-2 relative z-1">
                            ...
                            {offset && (
                                <div className="mt-16 px-8" onClick={loadMore}>
                                    <button
                                        className="flex flex-col justify-center items-center text-light text-[22px] cursor-pointer text-center mx-auto lg:mx-0">
                                        Xem thêm
